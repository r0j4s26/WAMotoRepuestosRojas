        ...
        public HttpResponseMessage Post([FromBody] Usuarios usuarios)
        {
            try
            {
                ...
                if (Usuario == null)
                {
                    ...
                    var NombreUsuario = db.Usuarios.Where(a => a.NombreUsuario.ToUpper() == usuarios.NombreUsuario.ToUpper()).FirstOrDefault();
                
                    if (NombreUsuario != null)
                    {
                        throw new Exception("Ya existe un usuario con este numero cedula");
                    }
